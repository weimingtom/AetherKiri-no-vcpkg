...
## (added, for )
## (cpp/core/tjs2/tjsConfig.cpp:18:10: fatal error: boost/locale.hpp: No such file or directory
## (   18 | #include <boost/locale.hpp>
## sudo apt install libboost-locale-dev
##
##sual/impl -Icpp/core/plugin -Icpp/plugins -Ibridge/engine_api/include -o cpp/core/visual/ogl/RenderManager_ogl.o -c cpp/##core/visual/ogl/RenderManager_ogl.cpp
##In file included from cpp/core/visual/ogl/RenderManager_ogl.cpp:1:
##cpp/core/visual/ogl/krkr_texture2d.h:25:1: error: ‘ssize_t’ does not name a type; did you mean ‘size_t’?
##   25 | ssize_t hello;
##      | ^~~~~~~
##      | size_t
##cpp/core/visual/ogl/krkr_texture2d.h:114:41: error: ‘ssize_t’ has not been declared
##  114 |     bool initWithData(const void *data, ssize_t dataLen, PixelFormat format,
##      |                                         ^~~~~~~
##gedit cpp/core/visual/ogl/krkr_texture2d.h
##
##cpp/core/movie/ffmpeg/Demux.h:6:10: fatal error: libavcodec/avcodec.h: No such file or directory
##    6 | #include "libavcodec/avcodec.h"
##      |          ^~~~~~~~~~~~~~~~~~~~~~
##compilation terminated.
##make: *** [Makefile:720: cpp/plugins/alphamovie.o] Error 1
##gedit cpp/core/movie/ffmpeg/Demux.h
##sudo apt install libavcodec-dev
##
##cpp/plugins/alphamovie.cpp:23:10: fatal error: libswscale/swscale.h: No such file or directory
...
##
##ngine_api.o -c bridge/engine_api/src/engine_api.cpp
##bridge/engine_api/src/engine_api.cpp:96:10: fatal error: libavformat/avformat.h: No such file or directory
...
##-DAETHERKIRI_ENABLE_ARTEMIS_RUNTIME -DBOOST_LOCALE_DYN_LINK -DBOOST_LOCALE_NO_LIB -DDEBUG -DFMT_SHARED -DSPDLOG_COMPILED_LIB -DSPDLOG_FMT_EXTERNAL -DSPDLOG_SHARED_LIB -D_DEBUG
CPPFLAGS += -DAETHERKIRI_ENABLE_ARTEMIS_RUNTIME
CPPFLAGS += -DBOOST_LOCALE_DYN_LINK
CPPFLAGS += -DBOOST_LOCALE_NO_LIB
CPPFLAGS += -DFMT_SHARED
CPPFLAGS += -DSPDLOG_COMPILED_LIB
CPPFLAGS += -DSPDLOG_FMT_EXTERNAL
CPPFLAGS += -DSPDLOG_SHARED_LIB
...
CPPFLAGS += -Icpp/core/visual/godot
CPPFLAGS += -Icpp/core/plugin
CPPFLAGS += -Icpp/plugins
CPPFLAGS += -Ibridge/engine_api/include

##FIXME:added
CPPFLAGS += -I./godot-cpp-10.0.0-rc1/gen/include
CPPFLAGS += -I./godot-cpp-10.0.0-rc1/include
...
OBJS += bridge/engine_api/src/engine_api_dispatch.o
OBJS += bridge/engine_api/src/engine_runtime_provider.o
###OBJS += platforms/android/cpp/krkr2_android.o

KRKR2_OBJS := 

all : libaether_kiri_godot.so
	cp libaether_kiri_godot.so ./apps/godot_app/bin/linux/debug/libaether_kiri_godot.so

#platforms/linux/main.cpp platforms/linux/test.cpp  
libaether_kiri_godot.so: bridge/godot_extension/src/aether_kiri_godot.cpp bridge/godot_extension/src/frame_effect_host.cpp krkr2.a godot-cpp-10.0.0-rc1/libgodot-cpp.a $(KRKR2_OBJS)
	$(CPP) -Wl,--no-undefined bridge/godot_extension/src/aether_kiri_godot.cpp bridge/godot_extension/src/frame_effect_host.cpp $(KRKR2_OBJS) krkr2.a godot-cpp-10.0.0-rc1/libgodot-cpp.a -shared -o $@ $(CPPFLAGS) $(LDFLAGS)
#$(CPP) $(KRKR2_OBJS) krkr2.a -o $@ $(CPPFLAGS) $(LDFLAGS)
#platforms/linux/main.cpp platforms/linux/test.cpp 
...
clean :
	$(RM) $(OBJS) $(KRKR2_OBJS) krkr2.a krkr2 libaether_kiri_godot.so ./apps/godot_app/bin/linux/debug/*.so
...
#Vulkan 1.4.305 - Forward Mobile - Using Device #0: Unknown - llvmpipe (LLVM 19.1.7, 256 bits)
#
#Embedded window can't be resized.
#Embedded window can't be moved.
#  ERROR: Can't open dynamic library, file not found: '/home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so'.
#  ERROR: GDExtension dynamic library not found: 'res://aether_kiri.gdextension'.
#  ERROR: Can't open dynamic library, file not found: '/home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so'.
#  ERROR: GDExtension dynamic library not found: 'res://aether_kiri.gdextension'.
...
#ERROR: AetherKiri runtime extension class is unavailable.
#   at: push_error (core/variant/variant_utility.cpp:1023)
#   GDScript backtrace (most recent call first):
#       [0] _create_runtime_player (res://scripts/main.gd:9895)
#       [1] _ready (res://scripts/main.gd:9604)
#ERROR: Can't open dynamic library: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so. Error: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so: undefined symbol: _ZN5godot4Node8_processEd.
#   at: open_dynamic_library (drivers/unix/os_unix.cpp:1066)
#
#$ nm ./libaether_kiri_godot.so | grep _ZN5godot4Node8_processEd | c++filt 
#                 U godot::Node::_process(double)
#


#ERROR: Can't open dynamic library: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so. Error: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so: undefined symbol: _ZN6spdlog5sinks9base_sinkISt5mutexE3logERKNS_7details7log_msgE.
#   at: open_dynamic_library (drivers/unix/os_unix.cpp:1066)
#ERROR: Can't open GDExtension dynamic library: 'res://aether_kiri.gdextension'.
#   at: open_library (core/extension/gdextension.cpp:811)
#ERROR: Can't open dynamic library: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so. Error: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so: undefined symbol: _ZN6spdlog5sinks9base_sinkISt5mutexE3logERKNS_7details7log_msgE.
#
#
#nm ./libaether_kiri_godot.so | grep _ZN6spdlog5sinks9base_sinkISt5mutexE3logERKNS_7details7log_msgE | c++filt 
#                 U spdlog::sinks::base_sink<std::mutex>::log(spdlog::details::log_msg const&)



#ERROR: Can't open dynamic library: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so. Error: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so: undefined symbol: _ZN7KRMovie14TVPMoviePlayer7ReleaseEv.
#   at: open_dynamic_library (drivers/unix/os_unix.cpp:1066)
#ERROR: Can't open GDExtension dynamic library: 'res://aether_kiri.gdextension'.
#   at: open_library (core/extension/gdextension.cpp:811)
#ERROR: Can't open dynamic library: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so. Error: /home/wmt/AetherKiri/apps/godot_app/bin/linux/debug/libaether_kiri_godot.so: undefined symbol: _ZN7KRMovie14TVPMoviePlayer7ReleaseEv.
...
#nm ./libaether_kiri_godot.so | grep _ZN7KRMovie14TVPMoviePlayer7ReleaseEv | c++filt 
#                 U KRMovie::TVPMoviePlayer::Release()
